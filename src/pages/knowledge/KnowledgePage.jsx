    ...
    <div className="kb">
      ...
      <section className="kb-card kb-upload">
        ...
        <div className="kb-category-row">
          <input placeholder="대분류 (예: 기술)" value={categoryL1} onChange={(e) => setCategoryL1(e.target.value)} disabled={uploading} />
          <input placeholder="중분류 (예: AI)" value={categoryL2} onChange={(e) => setCategoryL2(e.target.value)} disabled={uploading} />
          <input placeholder="소분류 (예: AI챗봇)" value={categoryL3} onChange={(e) => setCategoryL3(e.target.value)} disabled={uploading} />
        </div>
