  ...
  return (
    <header className="topbar">
      ...
      <div className="top-actions">
        <button className="search-trigger" onClick={onSearch}><Search size={17} /><span>전체 검색</span><kbd>⌘ K</kbd></button>
        <button className="quick-button" onClick={onQuick}><Plus size={18} /> <span>빠른 추가</span></button>
      </div>
    </header>
  )
}
